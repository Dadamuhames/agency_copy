...
MIDDLEWARE = [
    ...
    "agency.middleware.LoginRequiredMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "agency.language_context_processor.language_context",
            ],
        },
    },
]
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://polimer.vercel.app",
] + env.list("CORS_ORIGINS")
...
CACHES = {
    "default": {
        ...
        "LOCATION": "/var/tmp/django_cache/agency",
    }
}
